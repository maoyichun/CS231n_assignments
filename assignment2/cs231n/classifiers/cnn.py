...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        conv_forward_out_1, cache_forward_1 = conv_relu_pool_forward(X,
                                                                     ...
                                                                     conv_param,
                                                                     pool_param)
        affine_relu_out2, cache_affine_relu2 = affine_relu_forward(conv_forward_out_1,
                                                                   self.params['W2'],
                                                                   self.params['b2'])
        scores, cache_affine3 = affine_forward(affine_relu_out2,
                                               self.params['W3'],
                                               self.params['b3'])
        ############################################################################
        #                             END OF YOUR CODE                             #
        ...
        dx3, grads['W3'], grads['b3'] = affine_backward(dscores, cache_affine3)
        dx2, grads['W2'], grads['b2'] = affine_relu_backward(dx3, cache_affine_relu2)
